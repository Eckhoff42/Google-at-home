...
The selection of algorithms is inspired by the Stanford course [Introduction to Information Retrieval](https://web.stanford.edu/class/cs276/)
...
- [Search-engine-algorithm-collection](#search-engine-algorithm-collection)
  ...
  - [How to run the search engine](#how-to-run-the-search-engine)
...
3. Check the robots.txt file to see if the URL is allowed to be crawled
   1. check if the robots.txt is cashed 
